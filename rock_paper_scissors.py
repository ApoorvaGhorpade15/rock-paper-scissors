...
rock_img=PhotoImage(file=r"rock.png")  #location of the image rock
paper_img=PhotoImage(file=r"paper.png")  #location of the image paper
scissors_img=PhotoImage(file=r"scissors.png")  #location of the image scissors
def ROCK():
